 ...
 * $ pg-to-ts generate -c postgresql://username:password@localhost/eleutheria -t charts -t covers -t knex_migrations -t knex_migrations_lock -t note_skins -t scores -t sessions -t songs -t users -s public
 *
 */
